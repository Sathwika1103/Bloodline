					...
					<div class="panel panel-default" style="padding: 20px;">
						<div class="panel-body">
							...
							<div class="heading text-center">
								<h3>Welcome </h3> <h1><?php if(isset($_SESSION['name'])) echo $_SESSION['name'] ?><!-- Donor Name --></h1>
							</div>
							<p class="text-center">Here you can manage your account to update your profile</p>
